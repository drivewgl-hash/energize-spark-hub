...
export const HeroSection = ({ onNavigate }: HeroSectionProps) => {
  return (
    <section className="relative min-h-screen flex flex-col justify-between overflow-hidden pt-20 lg:pt-24 pb-32">
      {/* Hero Background */}
      <div 
      ...
      {/* Main Content */}
      <div className="relative z-10 container mx-auto px-4 text-center flex-1 flex flex-col justify-center max-w-6xl">
        {/* Logo Principal */}
        ...
        {/* Subtitle */}
        <p className="text-lg md:text-xl lg:text-2xl text-instituto-text-light/90 mb-12 lg:mb-16 max-w-3xl mx-auto leading-relaxed">
      ...
      <div className="relative z-10 w-full px-4 mb-16">
        <div className="container mx-auto max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
            <div className="bg-instituto-white/10 backdrop-blur-sm rounded-xl p-4 lg:p-6 border border-instituto-white/20 text-center">
